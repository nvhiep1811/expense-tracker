    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-text">Chào mừng bạn quay trở lại!</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-input-border rounded focus:ring-blue-500 cursor-pointer"
                />
