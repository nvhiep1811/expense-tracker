...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center px-4 py-12">
        ...
        <div className="bg-card-bg rounded-2xl shadow-xl p-8 border border-card-border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              onClick={async (e) => {
                e.preventDefault();
                if (isGoogleLoading || isFacebookLoading || isLoading) return;
